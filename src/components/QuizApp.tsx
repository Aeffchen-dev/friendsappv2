              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    transition: isDragging ? (dragDirection === 'horizontal' && !isActive && (position === 1 || position === -1) && dragJustWentHorizontal ? 'transform 150ms cubic-bezier(0.4, 0, 0.2, 1)' : 'none') : (isAnimating && dragDirection === 'horizontal' ? (isActive ? 'transform 350ms cubic-bezier(0.4, 0, 0.2, 1) 100ms' : 'transform 450ms cubic-bezier(0.4, 0, 0.2, 1)') : 'transform 200ms cubic-bezier(0.4, 0, 0.2, 1)'),
              ...
              return (
                <div 
                  ...
                  style={{
                    ...
                    transition: isDragging ? (dragDirection === 'horizontal' && !isCategoryActive && (catPosition === 1 || catPosition === -1) && dragJustWentHorizontal ? 'transform 150ms cubic-bezier(0.4, 0, 0.2, 1)' : 'none') : ((isAnimating || isHorizontalSliding) && dragDirection === 'horizontal' ? (isCategoryActive ? 'transform 350ms cubic-bezier(0.4, 0, 0.2, 1) 100ms' : 'transform 450ms cubic-bezier(0.4, 0, 0.2, 1)') : 'transform 200ms cubic-bezier(0.4, 0, 0.2, 1)'),
