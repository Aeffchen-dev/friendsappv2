              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    transition: isDragging ? 'none' : (isAnimating && dragDirection === 'horizontal' ? (isActive ? 'transform 350ms cubic-bezier(0.4, 0, 0.2, 1) 100ms' : 'transform 350ms cubic-bezier(0.4, 0, 0.2, 1)') : 'transform 350ms cubic-bezier(0.4, 0, 0.2, 1)'),
              ...
              return (
                <div 
                  ...
                  style={{
                    ...
                    transition: isDragging ? 'none' : ((isAnimating || isHorizontalSliding) && dragDirection === 'horizontal' ? (isCategoryActive ? 'transform 350ms cubic-bezier(0.4, 0, 0.2, 1) 100ms' : 'transform 350ms cubic-bezier(0.4, 0, 0.2, 1)') : 'transform 350ms cubic-bezier(0.4, 0, 0.2, 1)'),
