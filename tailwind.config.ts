	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				connection: {
					100: 'hsl(var(--connection-100))',
					200: 'hsl(var(--connection-200))',
					300: 'hsl(var(--connection-300))',
					400: 'hsl(var(--connection-400))',
					500: 'hsl(var(--connection-500))',
					600: 'hsl(var(--connection-600))',
					700: 'hsl(var(--connection-700))',
					800: 'hsl(var(--connection-800))',
					900: 'hsl(var(--connection-900))'
				},
				fuck: {
					100: 'hsl(var(--fuck-100))',
					200: 'hsl(var(--fuck-200))',
					300: 'hsl(var(--fuck-300))',
					400: 'hsl(var(--fuck-400))',
					500: 'hsl(var(--fuck-500))',
					600: 'hsl(var(--fuck-600))',
					700: 'hsl(var(--fuck-700))',
					800: 'hsl(var(--fuck-800))',
					900: 'hsl(var(--fuck-900))'
				},
				identity: {
					100: 'hsl(var(--identity-100))',
					200: 'hsl(var(--identity-200))',
					300: 'hsl(var(--identity-300))',
					400: 'hsl(var(--identity-400))',
					500: 'hsl(var(--identity-500))',
					600: 'hsl(var(--identity-600))',
					700: 'hsl(var(--identity-700))',
					800: 'hsl(var(--identity-800))',
					900: 'hsl(var(--identity-900))'
				},
				party: {
					100: 'hsl(var(--party-100))',
					200: 'hsl(var(--party-200))',
					300: 'hsl(var(--party-300))',
					400: 'hsl(var(--party-400))',
					500: 'hsl(var(--party-500))',
					600: 'hsl(var(--party-600))',
					700: 'hsl(var(--party-700))',
					800: 'hsl(var(--party-800))',
					900: 'hsl(var(--party-900))'
				},
				'wer-aus-der-runde': {
					100: 'hsl(var(--wer-aus-der-runde-100))',
					200: 'hsl(var(--wer-aus-der-runde-200))',
					300: 'hsl(var(--wer-aus-der-runde-300))',
					400: 'hsl(var(--wer-aus-der-runde-400))',
					500: 'hsl(var(--wer-aus-der-runde-500))',
					600: 'hsl(var(--wer-aus-der-runde-600))',
					700: 'hsl(var(--wer-aus-der-runde-700))',
				...
				quiz: {
					...
					'wer-aus-der-runde-bg': 'hsl(var(--quiz-wer-aus-der-runde-bg))',
